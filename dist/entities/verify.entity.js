...
var Verify = /** @class */ (function () {
    ...
    Verify.prototype.tokenCreate = function () {
    ...
    Verify.prototype.compare = function (token_1, token_2) {
        if (token_1 === token_2) {
            return true;
        }
        return false;
    ...
    ], Verify.prototype, "createdAt", void 0);
    __decorate([
        ...
        __metadata("design:type", Date)
    ], Verify.prototype, "updatedAt", void 0);
    Verify = __decorate([
        typeorm_1.Entity()
    ], Verify);
    return Verify;
