...
var Reseller = /** @class */ (function (_super) {
    __extends(Reseller, _super);
    function Reseller() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Reseller.prototype.encrypt = function (password) {
    ...
    Reseller.prototype.compare = function (password, resellerPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bcryptjs_1.default.compare(password, resellerPassword)];
    ...
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Reseller.prototype, "last_name", void 0);
    __decorate([
        typeorm_1.Column({
            default: false
        }),
    ...
    __decorate([
        typeorm_1.Column(),
        __metadata("design:type", String)
    ], Reseller.prototype, "password", void 0);
    __decorate([
        typeorm_1.Column({
            default: null
        }),
        __metadata("design:type", mongodb_1.ObjectID)
    ], Reseller.prototype, "sessionId", void 0);
    __decorate([
